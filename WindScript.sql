...
-- New Table Whit More Ditails About The Shipping.
...
-- The New Ditails From Another Database.

INSERT INTO Shipping
SELECT 
	OrderID, CustomerID, EmployeeID, 
	DATEADD(year, 23, OrderDate) AS [OrderDate], DATEADD(year, 23, RequiredDate) AS [RequiredDate], 
	DATEADD(year, 23, ShippedDate) AS [ShippedDate] FROM [NORTHWND].dbo.[Orders] AS Shipping;


--Creatig View for Order Status (On Time / Late / Unknow)
